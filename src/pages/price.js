...
import tableTotal from "assets/images/table-total.png"
import rectangle from "assets/images/Rectangle 1.png"
import teacher from "assets/images/teacher-2 2.png"
import closeButton from "assets/images/close.png"
import school from "assets/images/school 4.png"
import rightSymbol from "assets/images/right-symbol.png"
          ...
          <div className="three-columns-grid">
            <div className="price-1">
              <div className="pricing-calculator">
                <div className="price-title">Pricing Calculator</div>
                <div className="teacher-parent-container">
                  <div className="school-title">
                    <div className="school">School</div>
                    <img src={toggle} alt="" />
                    <div className="teacher-parent">Teacher/Parent</div>
                  </div>
                  <div className="number-of-student-container">
                    <div className="number-of-student">Number of Students</div>
                    <img src={frame1} alt="" />
                  </div>
                  <div className="number-of-years-container">
                    <div className="number-of-years">Number of Years</div>
                    <img src={frame2} alt="" />
                  </div>
                  <div className="numbers-of-year-total">
                    <img src={tableTotal} alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="number-of-Students-container">
                <div className="number-of-Students">Number of Students</div>
              </div>
              <div className="number-of-teacher-Parent-profiles-container">
                <div className="number-of-teacher-Parent-profiles">Number of Teacher/Parent Profiles</div>
              </div>
              <div className="shared-classes-container">
                <div className="shared-classes">
                  Shared Classes (Multiple teachers can be provided access to the same class)
                </div>
              </div>
              <div className="school-wide-reports-container">
                <div className="school-wide-reports">School-Wide Reports</div>
              </div>
              <div className="available-student-levels-container">
                <div className="available-student-levels">Available Student Levels</div>
              </div>
            </div>
            <div className="price-2">
              <div className="teacher-parent-account-container">
                <div className="teacher-parent-account">
                  <img src={teacher} alt="" />
                  <div className="teacher-parent-computer-title">Teacher/Parent Account</div>
                </div>

                <div className="teacher-parent-free">
                  <div className="free">FREE</div>
                  <div className="until-july">Until July 2024</div>
                </div>
                <div className="sign-up-for-free">
                  <div className="sign-up-for-free-title">Sign up for Free</div>
                </div>
              </div>
              <div className="account-teacher-parent-container">
                <div className="account-teacher-parent"></div>
                <div className="unlimited-container">
                  <div className="account-of-unlimited">Unlimited</div>
                </div>
                <div className="unlimited-container">
                  <div className="account-of-unlimited">1 per account</div>
                </div>

                <div className="account-of-close-container">
                ...
                <div className="unlimited-container">
                  <div className="account-of-unlimited">All</div>
                </div>
              </div>
            </div>
            <div className="price-3">
              <div className="school-account-container">
                <div className="school-account">
                  <img src={school} alt="" />
                  <div className="school-account-title">School Account</div>
                </div>
                <div className="student-year-container">
                  <div className="student-year">
                    <div className="student-year-title">$2</div>
                    <div className="student-year-per-title">Per Student / Per Year</div>
                  </div>
                  <div className="per-school">$1500 Maximum per school</div>
                </div>
                <div className="summer-button">
                  <div className="summer-button-title">Available Summer 2023</div>
                </div>
              </div>
              <div className="school-account-box">
                <div className="account-teacher-parent"></div>
                <div className="unlimited-container">
                  <div className="account-of-unlimited">100+</div>
                </div>
                <div className="unlimited-container">
                  <div className="account-of-unlimited-teacher-profile">
                    1 admin account, Unlimited teacher profiles
                  </div>
                </div>

                <div className="account-of-close-container">
                  <img src={rightSymbol} alt="" />
                </div>
      ...
      <section className="mfl-accordions-section section">
        <div className="three-column">
          <div className="two-container">
            <div className="teacher-parent-account-computer-container">
              <img src={rectangle} alt="" />
              <div className="teacher-parent-account-computer">
                <div className="teacher-parent-computer">
                  <img src={teacher} alt="" />
                  <div className="teacher-parent-computer-title">Teacher/Parent Account</div>
                </div>
                <div className="free-until-container">
                  <div className="free-until-title">FREE</div>
                  <div className="free-until--july-title">Until July 2024</div>
                </div>
                <div className="sign-up-for-free-computer-button-container">
                  <div className="sign-up-for-free-computer-button">Sign up for Free</div>
                </div>
              </div>
              <div className="feature-box-computer-container">
                <div className="feature-box-container">
                  <div className="feature-box-title">Features</div>
                </div>
                <div className="number-of-student-computer-container">
                  <div className="number-of-student-computer-title">Number of Students Unlimited</div>
                </div>
                <div className="number-of-teacher-parent-computer-container">
                  <div className="number-of-teacher-parent-computer-title">
                    Number of Teacher/Parent Profiles 1 per account
                  </div>
                </div>
                <div className="shared-class-computer-container">
                  <div className="shared-class-computer-title">
                    Shared Classes (Multiple teachers can be provided access to the same class)
                  </div>
                  <img src={closeButton} alt="" />
                </div>
                <div className="school-wide-reports-computer-container">
                  <div className="school-wide-reports-computer-title">School-Wide Reports</div>
                  <img src={closeButton} alt="" />
                </div>
                <div className="student-available-computer-container">
                  <div className="student-available-computer-title">Available Student Levels All</div>
                </div>
              </div>
            </div>

            <div className="school-account-computer-container">
              <div className="rectangles"></div>
              <div className="school-account-computer">
                <div className="school-computer">
                  <img src={school} alt="" />
                  <div className="school-computer-title">School Account</div>
                </div>
                <div className="per-student-year-computer-container">
                  <div className="per-student-year-computer">
                    <div className="per-student-computer-title">$2</div>
                    <div className="per-student-year-computer-title">Per Student / Per Year</div>
                  </div>
                  <div className="maximum-computer-title">$1500 Maximum per school</div>
                </div>
                <div className="available-computer-button-container">
                  <div className="available-computer-button">Available Summer 2023</div>
                </div>
              </div>

              <div className="features-box-computer-container">
                <div className="feature-box-container">
                  <div className="feature-box-title">Features</div>
                </div>
                <div className="number-student-container">
                  <div className="number-student-title">Number of Students 100+</div>
                </div>
                <div className="number-of-student-profile-container">
                  <div className="number-of-student-profile-title">
                    Number of Teacher/Parent Profiles 1 admin account, Unlimited teacher profiles
                  </div>
                </div>
                <div className="shared-classes-box-container">
                  <div className="shared-classes-box-title">
                    Shared Classes (Multiple teachers can be provided access to the same class)
                  </div>
                  <img src={rightSymbol} alt="" />
                </div>
                <div className="school-wide-box-container">
                  <div className="school-wide-box-title">School-Wide Reports</div>
                  <img src={rightSymbol} alt="" />
                </div>
                <div className="all-student-box-container">
                  <div className="all-student-box-title">Available Student Levels All</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="pricing-calculator-container">
            ...
            <div className="pricing-calculator-computer-title">Pricing Calculator</div>
            <div className="teacher-parent-total-container">
              <div className="teacher-parent-school-computer-container">
                <div className="school-box-title">School</div>
                <img src={toggle} alt="" />
                <div className="teacher-box-title">Teacher/Parent</div>
              </div>
              <div className="number-of-student-box-1-container">
                <div className="number-of-student-box-1-title">Number of Students</div>
                <img src={frame1} alt="" />
              </div>
              <div className="number-of-student-box-2-container">
                <div className="number-of-student-box-2-title">Number of Years</div>
                <img src={frame1} alt="" />
              </div>
              <div className="table-element-box-container">
                <div className="total-title-1">Total</div>
                <div className="total-title-2">$10</div>
              </div>
            </div>
          </div>
        </div>
